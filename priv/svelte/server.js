...
function Navbar($$renderer, $$props) {
  $$renderer.component(
    ($$renderer2) => {
      ...
      if (mobileMenuOpen) {
        $$renderer2.push("<!--[-->");
        $$renderer2.push(`<ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">`);
        push_element($$renderer2, "ul", 41, 8);
        $$renderer2.push(`<li>`);
        push_element($$renderer2, "li", 42, 10);
        $$renderer2.push(`<a href="#content">`);
        push_element($$renderer2, "a", 42, 14);
        $$renderer2.push(`Content</a>`);
        pop_element();
        $$renderer2.push(`</li>`);
        pop_element();
        $$renderer2.push(` <li>`);
        push_element($$renderer2, "li", 43, 10);
        $$renderer2.push(`<a href="#automation">`);
        push_element($$renderer2, "a", 43, 14);
        $$renderer2.push(`Automation</a>`);
        pop_element();
        $$renderer2.push(`</li>`);
        pop_element();
        $$renderer2.push(` <li>`);
        push_element($$renderer2, "li", 44, 10);
        $$renderer2.push(`<a href="#consulting">`);
        push_element($$renderer2, "a", 44, 14);
        $$renderer2.push(`Consulting</a>`);
        pop_element();
        $$renderer2.push(`</li>`);
        pop_element();
        $$renderer2.push(` <li class="mt-2">`);
        push_element($$renderer2, "li", 45, 10);
        $$renderer2.push(`<button class="btn btn-primary btn-sm w-full">`);
        push_element($$renderer2, "button", 46, 12);
        $$renderer2.push(`Get in Touch</button>`);
        pop_element();
        $$renderer2.push(`</li>`);
        pop_element();
        $$renderer2.push(`</ul>`);
      ...
      push_element($$renderer2, "a", 51, 4);
      $$renderer2.push(`urielm<span class="text-base-content/50">`);
      push_element($$renderer2, "span", 52, 12);
      ...
      $$renderer2.push(`</div>`);
      pop_element();
      $$renderer2.push(` <div class="navbar-center hidden md:flex">`);
      push_element($$renderer2, "div", 56, 2);
      $$renderer2.push(`<ul class="menu menu-horizontal px-1">`);
      push_element($$renderer2, "ul", 57, 4);
      $$renderer2.push(`<li>`);
      push_element($$renderer2, "li", 58, 6);
      $$renderer2.push(`<a href="#content">`);
      ...
      pop_element();
      $$renderer2.push(` <li>`);
      push_element($$renderer2, "li", 59, 6);
      $$renderer2.push(`<a href="#automation">`);
      push_element($$renderer2, "a", 59, 10);
      $$renderer2.push(`Automation</a>`);
      pop_element();
      $$renderer2.push(`</li>`);
      pop_element();
      $$renderer2.push(` <li>`);
      push_element($$renderer2, "li", 60, 6);
      $$renderer2.push(`<a href="#consulting">`);
      ...
      $$renderer2.push(`</div>`);
      pop_element();
      $$renderer2.push(` <div class="navbar-end">`);
      push_element($$renderer2, "div", 64, 2);
      $$renderer2.push(`<button class="btn btn-primary btn-sm">`);
      push_element($$renderer2, "button", 65, 4);
      $$renderer2.push(`Get in Touch</button>`);
      pop_element();
      $$renderer2.push(`</div>`);
      pop_element();
...
function ThemeToggle($$renderer, $$props) {
  $$renderer.component(
    ($$renderer2) => {
      ...
      $$renderer2.push(`<button class="relative w-12 h-12 rounded-full flex items-center justify-center hover:bg-base-200 transition-colors" aria-label="Toggle theme">`);
...
// import-glob:../svelte/**/*.svelte
var modules = [CodeSnippetCard_exports, Counter_exports, Navbar_exports, ThemeToggle_exports, WorkflowStatusCard_exports];
var __default = modules;
var filenames = ["../svelte/CodeSnippetCard.svelte", "../svelte/Counter.svelte", "../svelte/Navbar.svelte", "../svelte/ThemeToggle.svelte", "../svelte/WorkflowStatusCard.svelte"];
